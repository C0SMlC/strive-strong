...
const stats = [
  ...
  { number: "2-3", label: "Weeks to Recovery" },
];

export function Stats() {
  return (
    <section className="py-32 bg-gradient-to-br from-orange-500 via-amber-500 to-teal-500 text-white relative overflow-hidden">
      {/* Animated background */}
      <motion.div
